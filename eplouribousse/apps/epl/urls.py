...
urlpatterns = [
    ...
    path('rklist/<str:lid>/<str:xlid>', views.xranktotake, name='xto be ranked list'),
    ...
    path('arblist/<str:lid>/<str:xlid>', views.xarbitration, name='xarbitration'),
    path('arb1list/<str:lid>/<str:xlid>', views.x1arb, name='x1arbitration'),
    path('arb0list/<str:lid>/<str:xlid>', views.x0arb, name='x0arbitration'),
