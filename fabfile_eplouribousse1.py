...
env.application_name = 'eplouribousse1'   # name of webapp
...
def prod():
    ...
    # env.user = 'root'  # user for ssh
    env.backends = env.roledefs['web']
    env.server_name = 'eplouribousse1.di.unistra.fr'
    env.short_server_name = 'eplouribousse1'
    env.static_folder = '/static/'
