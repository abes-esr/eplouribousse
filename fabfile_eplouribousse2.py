...
env.application_name = 'eplouribousse2'   # name of webapp
...
def prod():
    ...
    # env.user = 'root'  # user for ssh
    env.backends = env.roledefs['web']
    env.server_name = 'eplouribousse2.di.unistra.fr'
    env.short_server_name = 'eplouribousse2'
    env.static_folder = '/static/'
